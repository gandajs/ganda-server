...
export class FunctionControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Function })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: FunctionCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Function] })
  @swagger.ApiForbiddenResponse()
  @swagger.ApiQuery({
    type: () => FunctionFindManyArgs,
    style: "deepObject",
    explode: true,
  })
  async findMany(
    ...
    const args = plainToClass(FunctionFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: FunctionWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ...
  async createHooks(
    @common.Param() params: FunctionWhereUniqueInput,
    @common.Body() body: FunctionWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
    const data = {
      hooks: {
    ...
    if (invalidAttributes.length) {
      ...
      throw new common.ForbiddenException(
        `Updating the relationship: ${
          invalidAttributes[0]
        } of ${"Function"} is forbidden for roles: ${roles}`
      );
    }
