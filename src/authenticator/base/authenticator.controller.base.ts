...
export class AuthenticatorControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Authenticator })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: AuthenticatorCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Authenticator] })
  ...
  async findMany(
    ...
    const args = plainToClass(AuthenticatorFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: AuthenticatorWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
